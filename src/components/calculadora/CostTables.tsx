            ...
            <CardContent className="space-y-12">
                ...
                <div className="rounded-lg border border-border p-2 space-y-2">
                    ...
                    <div key={item.id} className="grid grid-cols-1 md:grid-cols-12 items-center gap-2">
                        <div className="md:col-span-7"><Input {...register(`laborItems.${index}.description`)} placeholder="Descripción" className="bg-card" /></div>
                        <div className="md:col-span-2"><Input {...register(`laborItems.${index}.hours`, { valueAsNumber: true })} type="number" placeholder="Horas" className="bg-card text-center" /></div>
                        ...
                        <Controller
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger className="bg-card"><SelectValue placeholder="Categoría..." /></SelectTrigger>
                ...
                <div className="rounded-lg border border-border p-2 space-y-2">
                    ...
                    <div key={item.id} className="grid grid-cols-1 md:grid-cols-12 items-center gap-2">
                        <div className="md:col-span-5"><Input {...register(`variableCostItems.${index}.description`)} placeholder="Descripción" className="bg-card" /></div>
                        <div className="md:col-span-2"><Input {...register(`variableCostItems.${index}.quantity`, { valueAsNumber: true })} type="number" placeholder="Cantidad" className="bg-card text-center" /></div>
                        <div className="md:col-span-2"><Input {...register(`variableCostItems.${index}.cost`, { valueAsNumber: true })} type="number" placeholder="Costo/Unidad" className="bg-card text-center" /></div>
                        <div className="md:col-span-2">
                        <Controller
                            control={control}
                ...
                <div className="rounded-lg border border-border p-2 space-y-2">
                    ...
                    <div key={item.id} className="grid grid-cols-1 md:grid-cols-12 items-center gap-2">
                        <div className="md:col-span-7"><Input {...register(`fixedCostItems.${index}.description`)} placeholder="Descripción" className="bg-card" /></div>
                        <div className="md:col-span-2"><Input {...register(`fixedCostItems.${index}.quantity`, { valueAsNumber: true })} type="number" placeholder="Cantidad" className="bg-card text-center" /></div>
                        <div className="md:col-span-2"><Input {...register(`fixedCostItems.${index}.cost`, { valueAsNumber: true })} type="number" placeholder="Costo/Unidad" className="bg-card text-center" /></div>
