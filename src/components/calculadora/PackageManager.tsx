...
import { Save, FolderDown, Settings, Trash2, RotateCcw } from 'lucide-react';
...
export function PackageManager({ onReset, onLoadPackage }: PackageManagerProps) {
  ...
  return (
    <div className="rounded-xl border border-neutral-800 bg-neutral-900 p-4 flex flex-wrap items-center gap-4">
