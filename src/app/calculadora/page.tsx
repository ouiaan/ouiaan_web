      ...
      <FormProvider {...methods}>
        <main className="container mx-auto px-4 py-24 sm:py-32">
          ...
          <div className="my-12 max-w-4xl mx-auto">
            <PackageManager onReset={handleReset} onLoadPackage={handleLoadPackage} />
          </div>
